...
import argparse
import sys
from tmsExampleApp_publisher import tms_DeviceInfoPublisher
from tmsExampleApp_subscriber import tms_DeviceInfoSubscriber
...
def main():
    ...
    if(args.pub):
        print(f"Running tms_DeviceInfoPublisher on domain {args.domain}")
        tms_DeviceInfoPublisher.run_publisher(
            domain_id=args.domain,
            sample_count=args.sample_count)
    else:
        print(f"Running tms_DeviceInfoSubscriber on domain {args.domain}")
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Runs tms_DeviceInfoPublisher or tms_DeviceInfoSubscriber')
