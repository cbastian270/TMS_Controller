...
# this version brings in data from both ADCs

#In progress
# merging both data grabs into one output plot
# converting the data to real voltages and currents
# exporting the data in a TMS friednly packaging 
# Looping the code to collect continously
# verfiying the FFT analysis
# fixing the frequency calculation 

import time
import ADS1256_1 as ADS1256_1
import ADS1256_2 as ADS1256_2
...
separate_files('data_1.txt')          # run script

###################### end of data from ADC 1 #########################

##################### get data from ADC 2 #############################

#Setup for ADS input
ADC = ADS1256_2.ADS1256()
ADC.ADS1256_init()
strt_time = time.time()
cur_time = strt_time
...
separate_files('data_2.txt')          # run script

###################### end of data from ADC 2 #########################
